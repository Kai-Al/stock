package com.udea.stock.jsf;

import com.udea.stock.entity.TipoProducto;
import com.udea.stock.jsf.util.JsfUtil;
import com.udea.stock.jsf.util.PaginationHelper;
import com.udea.stock.ejb.TipoProductoFacade;
...
public class TipoProductoController implements Serializable {
    ...
    @EJB
    private com.udea.stock.ejb.TipoProductoFacade ejbFacade;
